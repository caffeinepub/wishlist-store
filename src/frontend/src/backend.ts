...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: bigint, arg3: Array<string>, arg4: string, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: Array<string>, arg5: string, arg6: string): Promise<void> {
        if (this.processError) {
            try {
